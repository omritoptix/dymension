...
func (k eibcHooks) AfterDemandOrderFulfilled(ctx sdk.Context, demandOrder *eibctypes.DemandOrder) error {
	err := k.UpdateRollappPacketRecipient(ctx, demandOrder.TrackingPacketKey, demandOrder.Recipient)
	if err != nil {
